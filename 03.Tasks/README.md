...
Данное домашнее задание является продолжением [домашнего задания](https://github.com/allseenn/git/tree/main/02.Tasks), которое вы выполняли на предыдущем семинаре в репозитории с [собственным проектом](https://github.com/allseenn/bash).
